...
<div class="container container p-3 my-3 bg-dark text-white">
    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="">
        <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="tname">Teacher Name:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="tname" name="tname" placeholder="Enter Tecaher name"
                           required autofocus>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="username">Teacher Username:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="username" name="username"
                           placeholder="Enter Tecaher USername" required>
                </div>
            </div>
            <div class="form-group">
            ...
            <input type="hidden" name="check" value="addteacher">

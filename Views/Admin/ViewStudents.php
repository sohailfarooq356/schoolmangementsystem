...
<div class="container">
    ...
    <table class="table table-dark">
        ...
        foreach ($result as $row) {
            ...
            echo'<td><input type="hidden" name="std_id" value="' . $row['std_id'] . '"/><input type="hidden" name="user_id" value="' . $row['user_id'] . '"/><input type="submit" class="btn btn-primary" value="Update" /></form>&nbsp;&nbsp;<a href="?type=delete&user_id=' . $row['user_id'] . '" class="btn btn-danger">Delete</a></td>';
            echo'</tr>';
        }
        ?>
        </tbody>
